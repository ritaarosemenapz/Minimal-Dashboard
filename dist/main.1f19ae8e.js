...
function getRandomQuote() {
  return _getRandomQuote.apply(this, arguments);
}

function _getRandomQuote() {
  _getRandomQuote = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, data;
...
function displayQuote() {
  ...
  getRandomQuote().then(function (data) {
    var randomQuote = Math.floor(Math.random() * data.length);
    quoteContainer.innerHTML = "\n        <blockquote>\"".concat(data[randomQuote].text, "\" \u2013 ").concat(data[randomQuote].author, "</blockquote>\n        ");
  });
}
...
function displayGreeting() {
  ...
  var savedUsername = localStorage.getItem("username");
  greetingContainer.innerHTML = "<h2>".concat(getGreetingTime(), ", ").concat(savedUsername, "</h2>");
  var currentTime = new Date().toLocaleTimeString("ko-KO", {
    timeStyle: "medium"
  });
  var currentDate = new Date().toLocaleDateString("ko-KO");
  document.getElementById("clock-info").innerHTML = "\n    <h3>".concat(currentDate, "</h3>\n    <h3>").concat(currentTime, "</h3>\n    ");
...
function _getCurrentWeather() {
  _getCurrentWeather = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var locationInput, locationQuery, savedLocation, response, data;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 6;
            return fetch("https://apis.scrimba.com/openweathermap/data/2.5/weather?q=".concat(locationQuery, "&units=metric"));
...
function togglePomodoroVisibility() {
  ...
  var greetingContainer = document.getElementById("greeting");
  var clockContainer = document.getElementById("clock-info");
...
function displayTasks() {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      taskContainer.innerHTML += "\n        <div id=\"task-item\" class=\"task-item\">\n          <input type=\"checkbox\" value=\"".concat(task, "\">\n          <ul id=\"current-task\">").concat(task, "</ul>\n        </div>\n        ");
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
function markAsDone() {
  ...
  checkBoxes.forEach(function (box) {
    box.addEventListener("change", function () {
      var _iterator2 = _createForOfIteratorHelper(currentTasks),
          _step2;

      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
          var task = _step2.value;
          if (task.innerHTML === box.value) task.classList.toggle("done-task");
        }
      } catch (err) {
        _iterator2.e(err);
      } finally {
...
function loadCompletedSessions() {
  ...
  pomodoroStats.innerHTML = "<div><i class=\"fa-solid fa-fire\"></i> ".concat(completedIntervals);
}
